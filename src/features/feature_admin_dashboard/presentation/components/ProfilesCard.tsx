...
import {useTenantProfilesCount} from "@/features/feature_admin_dashboard/presentation/hooks/useTenantProfilesCount";

const ProfilesCard = () => {

  const {data, isLoading, error} = useTenantProfilesCount();
